...
<p align="center">
  <!--
    ...
    then bump the matching `v0.1.14` / `relux-local-0.1.14-...` strings in the
  ...
  -->
  <a href="https://github.com/itsramananshul/Relux/releases/tag/relux-v0.1.14"><img src="https://img.shields.io/badge/release-relux--v0.1.14-blue?style=for-the-badge" alt="Release relux-v0.1.14"></a>
