...
#### Run the packaged release (v0.1.8, no build needed)
...
(`relux-local-0.1.8-windows-x64.zip`), extract it, and launch it - no Rust, no npm:

```powershell
# inside the extracted relux-local-0.1.8-windows-x64 folder
