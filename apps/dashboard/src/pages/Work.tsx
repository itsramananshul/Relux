...
export function OversightApprovalRow({
  ...
  return (
    <div className="card sm" style={{ padding: 8, border: "1px solid var(--border)" }}>
      ...
      <ApprovalInlineDecisions approval={a} onDecided={onReload} />
    </div>
  );
}
